...
test("participant registry defines the supported sets", () => {
  ...
  assert.deepEqual(DEBATE_PARTICIPANT_SETS.default, ["debate-glm", "debate-opus", "debate-openai"])
  assert.deepEqual(DEBATE_PARTICIPANT_SETS.cheap, ["debate-glm", "debate-qwen", "debate-deepseek"])
})
