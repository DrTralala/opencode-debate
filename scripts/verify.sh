...
assert_contains "README.md" '"opencode-debate@2.2.0"'
...
assert_contains "README.md" 'https://github.com/DrTralala/opencode-debate/tree/v2.2.0'
assert_contains "README.md" 'img.shields.io/badge/version-v2.2.0-blue.svg?style=flat-square'
